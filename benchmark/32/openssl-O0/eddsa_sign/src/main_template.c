...
#ifdef OAEP
extern const unsigned char CIPHERTEXT_OAEP[];
extern const unsigned int CIPHERTEXT_OAEP_LEN;
#else
...
#elif defined(EXAMPLE_RSA_DECRYPT)
#ifdef OAEP
    outlen = rsa_decrypt_tester(CIPHERTEXT_OAEP, CIPHERTEXT_OAEP_LEN, out);
#else
